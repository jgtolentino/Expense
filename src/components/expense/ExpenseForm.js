...
var ReceiptUploader_1 = require("./ReceiptUploader");
var ExpenseFormFields_1 = require("./ExpenseFormFields");
var ExpenseForm = function () {
    ...
    var handleProjectCodeChange = function (code) {
        setFormData(function (prev) { return (__assign(__assign({}, prev), { projectCode: code })); });
    };
    var handleSubmit = function (e) {
        ...
        try {
            addExpense({
                ...
                status: expense_1.ExpenseStatus.PENDING,
    ...
    return (<form onSubmit={handleSubmit} className="space-y-6 bg-white rounded-lg shadow p-6">
      <ReceiptUploader_1.ReceiptUploader onDataExtracted={handleDataExtracted} onError={setError}/>

      {error && (<div className="bg-red-50 border-l-4 border-red-400 p-4">
          <p className="text-red-700">{error}</p>
        </div>)}

      <ExpenseFormFields_1.ExpenseFormFields formData={formData} onChange={handleChange} onProjectCodeChange={handleProjectCodeChange}/>
